...
namespace HikariLegalSRL.Migrations
{
    ...
    [Migration("20260910063042_AddActividadesSeguimiento")]
    partial class AddActividadesSeguimiento
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HikariLegalSRL.Models.ActividadSeguimiento", b =>
                {
                    b.Property<int>("ActividadSeguimientoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ActividadSeguimientoId"));
                    ...
                    b.HasKey("ActividadSeguimientoId");
            ...
            modelBuilder.Entity("HikariLegalSRL.Models.ActividadSeguimiento", b =>
                {
                    b.HasOne("HikariLegalSRL.Models.Prospecto", "Prospecto")
                        .WithMany()
                        .HasForeignKey("ProspectoId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("HikariLegalSRL.Models.ApplicationUser", "Responsable")
                        .WithMany()
                        .HasForeignKey("ResponsableId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("HikariLegalSRL.Models.ApplicationUser", "UsuarioRegistro")
                        .WithMany()
